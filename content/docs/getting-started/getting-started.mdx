...
description: Learn how to connect and start building on Swell Network L2, the Restaking Yield Layer of the Superchain
---
...
- How to bridge assets to Swell L2
...
To interact with Swell L2, you need to add the following networks to your wallet:
...
1. Switch your wallet network to Swell L2 Testnet
2. Navigate to the [Swell Faucet](https://faucet.swellnetwork.io)
3. Connect your wallet and request testnet ETH

### Asset Bridging

The [Swell Bridge](https://bridge.swellnetwork.io) enables asset transfers between Ethereum and Swell L2:
...
Let's deploy your first contract on Swell L2.
...
Swell L2 combines the Optimism Superchain with AltLayer's restaking infrastructure:
...
Swell L2 transactions include two components:
